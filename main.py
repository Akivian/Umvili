"""
Umvili - Main Entry Point

A sandbox-style multi-agent reinforcement learning (MARL) algorithm comparison platform
with real-time visualization. Supports multiple agent algorithms (IQL, QMIX, rule-based, etc.)

Design Principles:
- Single Responsibility: Each class and method has a clear, single responsibility
- Open-Closed Principle: Easy to extend with new simulation types and features
- Dependency Injection: Flexible behavior control through configuration
